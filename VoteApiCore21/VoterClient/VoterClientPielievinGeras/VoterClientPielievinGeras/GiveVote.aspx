        ...
        $(document).ready(function () {
            ...
            $.getJSON(uri)
                .done(function (data) {
                    ...
                    //    //var uri = "http://dmitrogeras-eval-test.apigee.net/votesystem/api/votes";
                    ...
                    $('.vote').click(function () {
                        //var candidate_id = $(this).data('id');
                        var uri = "https://ey8ola9nmf.execute-api.us-east-2.amazonaws.com/hiring";
                        //var uri = "http://pielievingerasapivoter-dev.us-east-2.elasticbeanstalk.com/api/votes";
                        //var uri = "http://dmitrogeras-eval-test.apigee.net/votesystem/api/votes";
                        var datas = "{name : 'Dimitri Geras', email: 'dmitro.geras@gmail.com'}";
                        $.ajax({
                            url: uri,
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
